...
CREATE TABLE `teacher` (
  ...
  `tc_nickname` varchar(10) NOT NULL DEFAULT '攻城狮' COMMENT '讲师昵称',
  ...
  `tc_brithday` datetime NOT NULL DEFAULT NOW() COMMENT '讲师生日',
  ...
  `tc_join_time` datetime NOT NULL DEFAULT NOW() COMMENT '入职时间',
...
CREATE TABLE `lesson` (
  ...
  `ls_brief` varchar(255) NOT NULL DEFAULT '' COMMENT '课时简介',
